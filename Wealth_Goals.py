...
if add_purchases:
    target_required_return = required_return_with_big_purchase
else:
    target_required_return = required_return

if st.button("Continue to Asset Allocation"):

    st.session_state["target_required_return"] = target_required_return

    st.switch_page("pages/2_Asset_Allocation.py")


# paste this 2 to start website
